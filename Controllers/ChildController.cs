...
namespace Iroh.Controllers
{
    ...
    public class ChildController : ControllerBase
    {
        ...
        [HttpGet("children/search-unified")]
        ...
        [HttpPost("customers/{parentId}/children")]
        ...
        [HttpGet("customers/{parentId}/children")]
        ...
        [HttpPut("children/{id}")]
        public async Task<IActionResult> Update(long id, [FromBody] ChildUpdateDto dto)
        {
            try
            {
                await _childService.UpdateChild(id, dto.name, dto.birthDate);
